...
Шифрование диска — переводит данные на диске в нечитаемый код, который нелегальный пользователь не сможет легко расшифровать. (рис. 1).
...
Стойкий пароль должен быть со спец. символами и длинный (рис. 4).
